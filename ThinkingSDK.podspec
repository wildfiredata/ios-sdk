Pod::Spec.new do |s|
  s.name             = 'ThinkingSDK'
  s.version          = '3.0.2-beta.1'
  s.summary          = 'Official ThinkingData SDK for iOS.'
  s.homepage         = 'https://github.com/WildfireDataAnalytics/ios-sdk'
  s.license          = 'Apache License, Version 2.0'
  s.author           = { 'ThinkingData, Inc' => 'sdk@galaxyok.cn' }
  s.source           = { :git => 'https://github.com/WildfireDataAnalytics/ios-sdk.git', :tag => "v#{s.version}" }
  s.requires_arc     = true
